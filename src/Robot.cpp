...
//std::unique_ptr<Preferences> Robot::preference;
...
void Robot::RobotInit() {
    ...
    //preference.reset(Preferences::GetInstance());
...
void Robot::TeleopInit() {
    ...
    SmartDashboard::PutNumber("LeftMotor1",RobotMap::chassisleftMotor1->Get());
    SmartDashboard::PutNumber("LeftMotor2",RobotMap::chassisleftMotor2->Get());
    SmartDashboard::PutNumber("LeftMotor3",RobotMap::chassisleftMotor3->Get());
    ...
    //SmartDashboard::PutNumber("MotorSpeedL2", R)

    RobotMap::chassisrightMotor2->SetEncPosition(0);
}
