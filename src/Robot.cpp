...
void Robot::RobotInit() {
	...
	chooser.reset(new SendableChooser());
		chooser->AddDefault("Moat/Rock Wall/Rough Terrain/ Rampart", new AutoDrive(AutoDrive::Distance_Cross));
		chooser->AddObject("Low Bar", new AutoDrive(AutoDrive::Distance_LowBar));
		chooser->AddObject("Portcullis/Cheval de Frise", new AutoDrive(AutoDrive::Distance_Reach));
		chooser->AddObject("Do Nothing", new AutoDrive(AutoDrive::Distance_Reach));
...
void Robot::AutonomousInit() {
	autonomousCommand.reset(new AutoDrive(AutoDrive::Distance_Cross));
