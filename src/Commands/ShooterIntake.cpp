...
ShooterIntake::ShooterIntake(double shooterIntakeVoltage, double rollerVoltage): Command() {
    m_shooterIntakeVoltage = shooterIntakeVoltage;
    m_rollerVoltage = rollerVoltage;
