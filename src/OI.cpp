...
OI::OI() {
	...
	//SmartDashboard::PutString("Co-Driver", selector);
	SmartDashboard::GetString("Co-Driver", selector);
...
if(selector == "Fish"){
    ...
    coButtonY->WhenPressed(new ShooterIntake(1));
...
if(selector == "Ediseri"){
    ...
    dButtonRB->WhileHeld(new ShooterIntake(-1));
