...
OI::OI() {
    ...
    if(count == 1)
    {
		...
		coButtonRB.reset(new JoystickButton(coDriver.get(), 6));
		coButtonRB->WhenPressed(new IntakeArmOn(0.3));
    ...
    dButtonRB->WhileHeld(new IntakeArmOn(0.5));
    dButtonLB.reset(new JoystickButton(driver.get(), 5));
    dButtonLB->WhileHeld(new IntakeArmOn(-.75));
    ...
    dButtonB->WhenReleased(new KickstandToggle());
