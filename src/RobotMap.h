...
public:
	...
	static std::shared_ptr<CANTalon> shootershooterMotor3;
	static std::shared_ptr<DoubleSolenoid> shootershooterLift1;
	static std::shared_ptr<DoubleSolenoid> shootershooterLift2;
