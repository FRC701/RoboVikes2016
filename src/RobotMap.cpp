...
std::shared_ptr<Relay> RobotMap::lightsfeatureLights;
std::shared_ptr<Relay> RobotMap::lightsshooterLight;
...
void RobotMap::init() {
    ...
    chassiskickstand.reset(new DoubleSolenoid(4, 5));
    ...
    // Arm Motors...
    intakeintakeMotor3.reset(new CANTalon(20));
    lw->AddActuator("Intake", "intakeMotor3", intakeintakeMotor3);
    
    intakeintakeMotor4.reset(new CANTalon(21));
    ...
    lightsshooterLight.reset(new Relay(1));
    lw->AddActuator("Lights", "shooterLight", lightsshooterLight);
