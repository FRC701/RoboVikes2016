...
void RobotMap::init() {
    ...
    chassisleftMotor1.reset(new CANTalon(8));
    lw->AddActuator("Chassis", "leftMotor1", chassisleftMotor1);
    
    chassisleftMotor2.reset(new CANTalon(9));
    lw->AddActuator("Chassis", "leftMotor2", chassisleftMotor2);
    
    chassisleftMotor3.reset(new CANTalon(10));
    ...
    shootershooterMotor2.reset(new CANTalon(2));
    ...
    lw->AddActuator("Shooter", "liftShooter1", shooterliftShooter);
