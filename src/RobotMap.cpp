...
std::shared_ptr<ADIS16448_IMU> RobotMap::chassisbreakoutboard;
...
void RobotMap::init() {
    ...
    chassisbreakoutboard.reset(new ADIS16448_IMU());
    lw->AddSensor("Chassis", "breaoutboard", chassisbreakoutboard);
