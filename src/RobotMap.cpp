...
std::shared_ptr<DoubleSolenoid> RobotMap::shootershooterLift1;
std::shared_ptr<DoubleSolenoid> RobotMap::shootershooterLift2;
...
void RobotMap::init() {
    ...
    shootershooterLift1.reset(new DoubleSolenoid(0, 4, 5));
    lw->AddActuator("Shooter", "shooterLift1", shootershooterLift1);
    
    shootershooterLift2.reset(new DoubleSolenoid(1, 0, 1));
    lw->AddActuator("Shooter", "shooterLift2", shootershooterLift2);
