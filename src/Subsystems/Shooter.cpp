...
static const int kDefaultPrepShooterSpeed = 6000;//4475;

Shooter::Shooter() : Subsystem("Shooter"), prepShooterSpeed(kDefaultPrepShooterSpeed) {
...
int Shooter::getPrepShooterSpeed(){
	return prepShooterSpeed;
}

void Shooter::setPrepShooterSpeed(int inPrepShooterSpeed){
	prepShooterSpeed = inPrepShooterSpeed;
}
