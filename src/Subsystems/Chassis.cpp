...
Chassis::Chassis() : Subsystem("Chassis") {
	static const int EncoderTickperFeet = 6252;
    ...
    leftMotor1->SetFeedbackDevice(CANTalon::QuadEncoder);
    leftMotor1->ConfigEncoderCodesPerRev(EncoderTickperFeet);
    ...
    leftMotor1->SetPID(20.0, 0.0, 0.0, 0.0);
    leftMotor1->Set(0.0);

    rightMotor1->SetFeedbackDevice(CANTalon::QuadEncoder);
    rightMotor1->ConfigEncoderCodesPerRev(EncoderTickperFeet);
    ...
    rightMotor1->SetPID(20.0, 0.0, 0.0, 0.0);
    rightMotor1->Set(0.0);
